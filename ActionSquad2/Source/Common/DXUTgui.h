...
public:
	...
	bool GetDontMinimize() { return m_bDontMinimize; }
    void SetDontMinimize(bool bDontMinimize) { m_bDontMinimize = bDontMinimize; }
...
public:
    ...
    virtual HRESULT OnInit(void) { return S_OK; }
    ...
    virtual bool CanHaveFocus(void)		{ return false; }
    virtual void OnFocusIn(void)		{ m_bHasFocus = true; }
    virtual void OnFocusOut(void)		{ m_bHasFocus = false; }
    virtual void OnMouseEnter(void)		{ m_bMouseOver = true; }
    virtual void OnMouseLeave(void)		{ m_bMouseOver = false; }

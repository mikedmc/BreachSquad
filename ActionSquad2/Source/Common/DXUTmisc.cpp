...
VOID CModelViewerCamera::Reset()
{
	...
	m_ViewArcBall.Reset();
	m_ViewArcBall.SetQuatNow(m_ViewArcBall.GetQuatInit());
}
...
//--------------------------------------------------------------------------------------
void CModelViewerCamera::SetViewParams(D3DXVECTOR3* pvEyePt, D3DXVECTOR3* pvLookatPt, D3DXVECTOR3* pvUpDir)
{
	...
	D3DXVECTOR3 vUp(0,1,0);
	D3DXMatrixLookAtLH(&mRotation, pvEyePt, pvLookatPt, pvUpDir);
...
LRESULT CModelViewerCamera::HandleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	if (wParam & MK_CONTROL && (((uMsg == WM_LBUTTONDOWN || uMsg == WM_LBUTTONDBLCLK) && m_nRotateCameraButtonMask & MOUSE_LEFT_BUTTON) ||
	...
	if (wParam & MK_CONTROL && ((uMsg == WM_LBUTTONUP && m_nRotateCameraButtonMask & MOUSE_LEFT_BUTTON) ||

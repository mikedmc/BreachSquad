...
public:
	...
	void			SetQuatInit(D3DXQUATERNION q)	{ m_qInit = q; }
	D3DXQUATERNION	GetQuatInit(void)				{ return m_qInit; }
...
protected:
	...
	D3DXQUATERNION	m_qInit;			// Initial quaternion
...
public:
	...
	void Reset(); 
	void SetViewParams(D3DXVECTOR3* pvEyePt, D3DXVECTOR3* pvLookatPt, D3DXVECTOR3* pvUpDir);
	...
	// Functions to get state
	D3DXMATRIX* GetWorldMatrix(void)	{ return &m_mWorld; }
	D3DXMATRIX* GetModelRotMatrix(void)	{ return &m_mModelLastRot;	}

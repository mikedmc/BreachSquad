...
void CApplication::Init()
{
	...
	g_camGameScreen.SetCamAnimationNone();
...
HRESULT CApplication::VerifyRequirements()
{
	HRESULT hr = S_OK;
	//
	// DirectX version detection (cere minim 9.0c)
	//
	...
	//te lasa sa intervii si sa pornesti totusi jocul daca nu te increzi in autodetectie
	if (FAILED(hr))
	{
...
void CApplication::App_Init_IMGUI(LPDIRECT3DDEVICE9 pDevice, HWND hwnd)
{
...
void CApplication::App_Paint_IMGUI(LPDIRECT3DDEVICE9 pDevice, bool show_demo_window, bool show_another_window, ImVec4 clear_color)
{
...
{
	App_Init_IMGUI(pd3dDevice, DXUTGetHWND());

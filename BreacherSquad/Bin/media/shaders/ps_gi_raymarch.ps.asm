...
//
    ...
    def c6, 0, 1, 0.600000024, 0.400000006
    def c7, 0.0833333358, 0, 0, 0
    defi i0, 12, 0, 0, 0
    defi i1, 24, 0, 0, 0
    dcl_texcoord v0.xy
    dcl_2d s1
    ...
    rep i0
      ...
      if_ne r2.z, -r2.z
        ...
        mul r2.z, r0.x, r1.x
        if_lt r2.z, c2.y
          texldl r6, r4.xzxw, s3
          texldl r7, r4.xzxw, s2
          mul r2.z, r6.x, c3.x
        else
          mov r7.xyz, c4.x
          mov r2.z, c4.x
        ...
        if_lt r2.z, c2.y
          mul r6, r4.xzxx, c6.yyyx
          texldl r6, r6, s4
        else
          mov r6.xyz, c4.x
        endif
        mul r2.z, r1.w, r1.w
        mad r2.z, r2.z, -r0.z, c6.y
        max r3.x, r2.z, c4.x
        pow r2.z, r3.x, c3.z
        mul r3.xyz, r6, c6.z
        mad r3.xyz, r7, c6.w, r3
        mad r5.xyz, r3, r2.z, r5
      endif
      add r5.w, r5.w, c6.y
    endrep
    mul oC0.xyz, r5, c7.x

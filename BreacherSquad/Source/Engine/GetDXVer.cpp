                                          ...
                                          WCHAR* pcDirectXVersionLetter )
{
    ...
    if( GetSystemDirectory( szPath, MAX_PATH ) != 0 )
    {
        ...
        StringCchCat( szFile, 512, L"\\ddraw.dll" );
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\d3drg8x.dll" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\dplayx.dll" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\dinput.dll" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\d3d8.dll" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {
            if( ( HIWORD( llFileVersion.HighPart ) == 4 && CompareLargeInts( llFileVersion,
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\mpg2splt.ax" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\dpnet.dll" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {
            if( ( HIWORD( llFileVersion.HighPart ) == 4 && CompareLargeInts( llFileVersion,
        ...
        StringCchCopy( szFile, 512, szPath );
        StringCchCat( szFile, 512, L"\\d3d9.dll" );
        if( SUCCEEDED( GetFileVersion( szFile, &llFileVersion ) ) )
        {

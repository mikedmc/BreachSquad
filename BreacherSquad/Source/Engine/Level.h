...
public:
	...
	// Array of actor pointers. Not keeping CLinkedList of objects because the initialization is made in the constructor.
	CArray<CActor*>			m_arrActors;				
...
///--- misc ---
	...
	///--- SCRIPT ---
	// touches the closest object (runs script)

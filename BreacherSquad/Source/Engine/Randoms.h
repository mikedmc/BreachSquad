...
public:
	CRandom(void);	
	/* Returns the number of random calls since last SetRandomSeed */
	int				GetRandomCallsCount();
	...
	int				RandInt( int min, int max );  //intoarce numere intre min si max, inclusiv
...
//functie rapida de noise, fara octave
...
//dai un array de probabilitati si numarul de elemente din array si iti intoarce index

		...
		switch ( nChar )
		{
			...
			case VK_F6:
			{
				if ( GameState::state == GAME_STATE_GAME )
				{
					...
					CVariantMap	varAIparams;
					varAIparams.SetVarFloat( L"posX", vpos.x );
					varAIparams.SetVarFloat( L"posY", vpos.y );

					__Scripts().StartScript(FastHash("SPAWN_AT_POS"), 0, &varAIparams);

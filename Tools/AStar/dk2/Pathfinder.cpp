...
{
	return parentGCost + ((nodex == parentx || nodey == parenty) ? MIN_COST : (MIN_COST + HALF_COST)); //NOTE: CRB very important that this is the same or lower than the heuristic when using the sorted open list
}
